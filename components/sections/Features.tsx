  ...
  return (
    <section id="features" className="py-20 bg-black">
        <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            <h2 className="text-3xl sm:text-5xl md:text-5xl font-medium text-center mt-8 max-w-4xl mx-auto leading-tight">
                Your <span className="text-[#C8FF00]">unfair advantage</span> <br></br> in the market
            </h2>
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6 max-w-4xl mx-auto">
